  ...
  return (
    <section id="fh5co-services" data-section="services">
              ...
              <div className="box-services">
                ...
                <div className="fh5co-post to-animate">
                  ...
                  <p>
                    ...
                    all of our digital gifts are of the highest quality, and that they
      ...
      <div className="core-features">
            <div className="grid2 to-animate" style={{ backgroundImage: "url(images/full_image_5.jpg)" }}>
            </div>
            <div className="grid2 fh5co-bg-color">
                <div className="core-f">
                <h2 className="to-animate">Core Features</h2>
                <div className="row">
